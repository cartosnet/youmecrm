...
#*****************************************************************************************/
  ...
  before_filter :authenticate_admin, :except => [:index, :update_profile_image,:save_tmp_img, :get_user_email, :profile,:save_profile_info, :update, :save_password,:load_header_count_user, :invite_user, :assign_unassign_deals, :assign_deal_to_user, :remove_lead, :edit_user, :block_unblock_user, :grant_revoke_admin, :save_daily_updates, :manage_daily_updates, :edit_daily_update, :delete_daily_update, :create_admin_user]
